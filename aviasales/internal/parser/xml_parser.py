"""Parse Aviasales XML flight data into FlightItinerary models."""
...
def _parse_flight_element(flight_elem: ET.Element) -> dict:
    data = {}
...
def _parse_pricing_element(pricing_elem: ET.Element) -> dict:
    data = {
